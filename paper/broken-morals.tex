...
\begin{abstract}
  ...
  Third, we show that participants exposed to the tool's output produce significantly more nuanced and higher-quality justifications across all dimensions of evaluation, with medium to large effect sizes, supporting the tool's potential to enhance ethical decision-making in organizational contexts.
\end{abstract}
